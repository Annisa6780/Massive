...
class LaporanDiterimaActivity : AppCompatActivity() {

    private lateinit var  rv_listpelapor : RecyclerView
    private lateinit var listPelapor : ArrayList<DataLaporanDiterima>
    ...
    private fun getUserData() {
        ...
        for (i in dataJudul.indices){
            val itemPel = DataLaporanDiterima(
                dataJudul[i],
                dataJenis[i],
                dataTanggal[i],
                dataStatus,
        ...
        val lapDiterimaListAdapter = AdapterLaporanDiterima(listPelapor)
        rv_listpelapor.adapter = lapDiterimaListAdapter
        lapDiterimaListAdapter.setOnItemClickListener(object : AdapterLaporanDiterima.onItemClickListener{
            override fun onItemClick(position: Int) {

                //Toast.makeText(this@PelaporActivity, "Kamu menklik item ke-$position", Toast.LENGTH_SHORT).show()
                val intent = Intent(this@LaporanDiterimaActivity, DetailPelaporActivity::class.java)
